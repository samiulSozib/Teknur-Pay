    ...
    <div className="h-[270px] rounded-2xl border border-gray-200 bg-[#C8FACD] dark:border-gray-800 dark:bg-white/[0.03] p-4 md:p-6">
      <div className="flex flex-col sm:flex-row items-center">
        ...
        <div className="flex-1 p-4 md:p-8 text-center sm:text-left">
          ...
          <button 
            className="mt-3 px-4 py-2 bg-green-600 rounded-lg text-white text-sm w-full sm:w-auto hover:bg-green-700 transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-green-300"
        ...
        <button 
          className="hidden md:flex relative items-center justify-center p-4 sm:p-3 cursor-pointer bg-transparent border-none focus:outline-none focus:ring-2 focus:ring-green-300 rounded-full"
          onClick={handleWhatsAppClick}
        ...
        >
          ...
          <div className="relative flex items-center justify-center w-[150px] h-[150px] sm:w-[200px] sm:h-[200px] rounded-full">
            <img src="/images/img/background.png" alt="" className="absolute inset-0 w-full h-full object-contain" />
          </div>
          
          {/* WhatsApp Icon */}
          <div className="absolute flex items-center justify-center w-[90px] h-[90px] sm:w-[120px] sm:h-[120px] bg-green-500 rounded-full shadow-lg border-4 border-white hover:bg-green-600 transition-colors">
            <img 
